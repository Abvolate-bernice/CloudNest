...
import com.bbj.lease.model.entity.SystemPost;
import com.bbj.lease.model.enums.BaseStatus;
import com.bbj.lease.web.admin.service.SystemPostService;
...
public class SystemPostController {
    ...
    private Result<IPage<SystemPost>> page(@RequestParam long current, @RequestParam long size) {
        ...
        Page<SystemPost> ipage = service.page(page);
    ...
    public Result updateStatusByPostId(@RequestParam Long id, @RequestParam BaseStatus status) {
        LambdaUpdateWrapper<SystemPost> wrapper = new LambdaUpdateWrapper<SystemPost>()
